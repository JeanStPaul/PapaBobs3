...
namespace PapaBobs3.Domain
{
    public class PizzaPriceManager
    {
        ...
        private static decimal calculateCrustCost(DTO.OrderDTO order, DTO.PizzaPriceDTO prices)
        {
            ...
            switch (order.Crust)
            {
                case PapaBobs3.DTO.Enums.CrustType.Regular:
                    cost = prices.RegularCrustCost;
                    break;

                case PapaBobs3.DTO.Enums.CrustType.Thin:
                    cost = prices.ThinCrustCost;
                    break;

                case PapaBobs3.DTO.Enums.CrustType.Thick:
        ...
        private static decimal calculateSizeCost(DTO.OrderDTO order, DTO.PizzaPriceDTO prices)
        {
            ...
            switch (order.Size)
            {
                case PapaBobs3.DTO.Enums.SizeType.Small:
                    cost = prices.SmallSizeCost;
                    break;
                case PapaBobs3.DTO.Enums.SizeType.Medium:
                    cost = prices.MediumSizeCost;
                    break;
                case PapaBobs3.DTO.Enums.SizeType.Large:
