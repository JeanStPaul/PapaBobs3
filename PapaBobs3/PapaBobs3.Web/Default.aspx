<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PapaBobs3.Web.Default" %>
...
<body>
    ...
    <div class="container">
        ...
        <div class="radio"><label><asp:RadioButton ID="creditRadioButton" runat="server" GroupName="PaymentGroup" Checked="true" /> Credit</label></div>
